...
class TalentWidget {
  ...
  _downloadReport() { var fp=this.shadow.getElementById('fullscreen-panel'); var css='*{box-sizing:border-box;margin:0;padding:0}body{font-family:Inter,-apple-system,BlinkMacSystemFont,"PingFang SC","Microsoft YaHei",sans-serif;max-width:1100px;margin:32px auto;padding:0 20px;color:#1D1D1F;line-height:1.7;background:#fafafa}'+
    ...
    '.card-avatar-wrap{width:60px;flex-shrink:0;padding:10px;display:flex;align-items:center;justify-content:center;background:rgba(34,197,94,.04)}.card-avatar{width:100%;min-height:56px;border-radius:10px;object-fit:cover;background:#f2f2f7}.cmp-avatar{width:56px;height:70px;border-radius:10px;object-fit:cover;background:rgba(255,255,255,.25);display:block;margin:0 auto 6px}.card-body{flex:1;min-width:0;padding:12px 14px}.card-top-inner{display:flex;align-items:flex-start;justify-content:space-between;min-width:0}'+
...
'.card-avatar-wrap{width:60px;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,rgba(34,197,94,0.06),rgba(34,197,94,0.02));padding:10px}.card-avatar{width:100%;height:100%;min-height:56px;border-radius:10px;object-fit:cover;background:var(--border-light)}'+
