...
'.card-avatar-wrap{width:60px;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,rgba(34,197,94,0.06),rgba(34,197,94,0.02));padding:8px 6px}.card-avatar{width:48px;height:60px;border-radius:8px;object-fit:cover;background:var(--border-light)}'+
'.report-avatar{width:130px;height:160px;border-radius:14px;object-fit:cover;object-position:center top;flex-shrink:0;background:linear-gradient(135deg,rgba(34,197,94,0.06),rgba(34,197,94,0.02))}.cmp-avatar{width:56px;height:70px;border-radius:10px;object-fit:cover;background:rgba(255,255,255,.25);display:block;margin:0 auto 6px}'+
