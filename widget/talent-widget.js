...
class TalentWidget {
  ...
  _downloadReport() { var fp=this.shadow.getElementById('fullscreen-panel'); var css='*{box-sizing:border-box;margin:0;padding:0}body{font-family:Inter,-apple-system,BlinkMacSystemFont,"PingFang SC","Microsoft YaHei",sans-serif;max-width:1100px;margin:32px auto;padding:0 20px;color:#1D1D1F;line-height:1.7;background:#fafafa}'+
    ...
    '.card-avatar,.cmp-avatar{width:36px;height:36px;border-radius:50%;object-fit:cover;background:#f2f2f7;display:block;margin:0 auto 4px}.report-avatar{width:72px;height:72px;border-radius:50%;object-fit:cover;background:#f2f2f7}'+
    ...
    '.report-header{display:flex;gap:20px;align-items:flex-start;margin-bottom:20px}.report-grade{text-align:center;flex-shrink:0}.report-info{flex:1}.report-name{font-size:1.5rem;font-weight:600;color:#1D1D1F}.report-meta{font-size:.875rem;color:#86868B;margin-top:4px}.report-score{font-size:2.5rem;font-weight:300;color:#22c55e}'+
